...
function fire_ajax_submit_productos(){
	var formData = {
	id : $("#formulario_productos #id").val(),
	idempresas : $("#formulario_productos #idempresas").val(),
	idmarcas : $("#formulario_productos #idmarcas").val(),
	idcontactos : $("#formulario_productos #idcontactos").val(),
	detalles : $("#formulario_productos #detalles").val()
	...
	$.ajax({
		...
		success:function(data){
			mostrar_mensaje_productos(data);
			console.log(data);
...
var listar_productos=function(){
	 var table = $('#productos_tabla').DataTable({
		 "responsive": true,
		 "destroy": true,
