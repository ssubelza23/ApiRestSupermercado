...
public class FileUploadMarcas {
	private static final String ABS_PATH="C:\\Tomcat 9.0\\webapps\\web\\src\\main\\resources\\static\\assets\\images\\marcas\\";

	private static String REAL_PATH="";

	private static final Logger logger=LoggerFactory.getLogger(FileUploadMarcas.class);
