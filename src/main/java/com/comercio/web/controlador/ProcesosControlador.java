...
public class ProcesosControlador {
	...
	public String procesos(Model model) {
		...
		model.addAttribute("descripcion",
				"Los procesos son las tareas que el sistema gestiona, en diferentes modulos y asignado a los perfiles correpondientes");
	...
	public String modProceso(@ModelAttribute("nuevoProceso") ProcesoBean r, BindingResult result, Model model)
			throws ParseException {
